...
Ниже изображены настройки TIM4 внутри STM32CobeIDE. Данный таймер отвечает за анимацию мерцания и за положение динозаврика во время прыжка. 

![TIM4_settings.png](images/TIM4_settings.png)

Ниже изображены настройки TIM9 внутри STM32CobeIDE. Данный таймер отвечает за переменную, которая отвечает за сдвиг кактуса на экране. Кратко, данный таймер отвечает за движение кактуса по экрану.

![TIM9_settings.png](images/TIM9_settings.png)

Ниже изображены настройки TIM10 внутри STM32CobeIDE. Данный таймер отвечает за время зажатия кнопки прыжка.

![TIM10_settings.png](images/TIM10_settings.png)

Ниже изображены настройки TIM12 внутри STM32CobeIDE. Данный таймер отвечает за счётчик игры, а именно количество очков, которые зарабатываются по мере игры, а также за время генерации нового кактуса.
